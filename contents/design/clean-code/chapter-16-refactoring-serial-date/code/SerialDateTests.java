...
public class SerialDateTests extends TestCase {
     ...
     * @param name the name.
     */
    public SerialDateTests(final String JavaDoc name) {
        super(name);
    }
    ...
    public void testWeekdayCodeToString() {
        ...
        final String JavaDoc test = SerialDate.weekdayCodeToString(SerialDate.SATURDAY);
    ...
    public void testMonthCodeToStringCode() {
        ...
        final String JavaDoc test = SerialDate.monthCodeToString(MonthConstants.DECEMBER);
    ...
    public void testSerialization() {
        ...
        try {
            ...
            ObjectOutput JavaDoc out = new ObjectOutputStream JavaDoc(buffer);
            out.writeObject(d1);
            out.close();
